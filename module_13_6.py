...
button_4 = InlineKeyboardButton(text='Формула расчета', callback_data='formulas')
...
async def information(message):
    await message.answer('Я помогу рассчитать дневную норму калорий!', reply_markup = kb)
